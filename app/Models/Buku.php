...
class Buku extends Model
{
    ...
    public $fillable = ['nama_judul', 'isbn', 'deskripsi', 'jml_halaman', 'cover', 'tgl_terbit', 'id_penulis',];
    public $visible = ['nama_judul', 'isbn', 'deskripsi', 'jml_halaman', 'cover', 'tgl_terbit', 'id_penulis',];
    ...
    {
        //data model genre memiliki banyak data dari model Buku
